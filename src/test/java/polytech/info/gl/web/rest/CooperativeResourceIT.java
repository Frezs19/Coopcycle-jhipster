...
class CooperativeResourceIT {
    ...
    public static Cooperative createEntity(EntityManager em) {
        Cooperative cooperative = new Cooperative().nom(DEFAULT_NOM).zone(DEFAULT_ZONE);
        return cooperative;
    }
    ...
    public static Cooperative createUpdatedEntity(EntityManager em) {
        Cooperative cooperative = new Cooperative().nom(UPDATED_NOM).zone(UPDATED_ZONE);
        return cooperative;
    }
    ...
    void putExistingCooperative() throws Exception {
        ...
        updatedCooperative.nom(UPDATED_NOM).zone(UPDATED_ZONE);
    ...
    void fullUpdateCooperativeWithPatch() throws Exception {
        ...
        partialUpdatedCooperative.nom(UPDATED_NOM).zone(UPDATED_ZONE);
