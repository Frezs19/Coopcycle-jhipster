...
class ProduitResourceIT {
    ...
    public static Produit createEntity(EntityManager em) {
        Produit produit = new Produit().nom(DEFAULT_NOM).description(DEFAULT_DESCRIPTION).prix(DEFAULT_PRIX);
        return produit;
    }
    ...
    public static Produit createUpdatedEntity(EntityManager em) {
        Produit produit = new Produit().nom(UPDATED_NOM).description(UPDATED_DESCRIPTION).prix(UPDATED_PRIX);
        return produit;
    }
    ...
    void putExistingProduit() throws Exception {
        ...
        updatedProduit.nom(UPDATED_NOM).description(UPDATED_DESCRIPTION).prix(UPDATED_PRIX);
    ...
    void fullUpdateProduitWithPatch() throws Exception {
        ...
        partialUpdatedProduit.nom(UPDATED_NOM).description(UPDATED_DESCRIPTION).prix(UPDATED_PRIX);
